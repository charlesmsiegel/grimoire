...
> Captures the Characters module as actually built. The companion `2026-05-16-characters-remaining-design.md` covers everything from the original `specs/08-characters.md` that did **not** land.
