...
export interface WorldMeta {
  ...
  tags: string[];
  genre: string;
  /** Legacy inline calendar — kept as fallback for worlds that haven't
   *  migrated to first-class Calendar entities yet. */
  calendar: Record<string, unknown>;
  /** Ids of Calendar entities (built-in or custom) attached to this world. */
  calendar_ids: string[];
  /** Ids of HolidaySet entities attached to this world. */
  holiday_set_ids: string[];
  /** Which calendar is the "display" one for scenes; others stay reconciled
   *  in the backend via JDN. */
...
// --------------------------------------------------------------------------
// Calendars + holiday sets (mirroring backend types/calendar.py)
// --------------------------------------------------------------------------
