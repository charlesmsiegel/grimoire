...
### 1. Scaffold backend + frontend + data layout
**Blocks:** everything
...
### 2. Define shared types and protocol stubs
**Blocked by:** 1
...
### 3. Implement in-process event bus
**Blocked by:** 1
...
### 5. Set up SQLite migrations + sqlite-vec
**Blocked by:** 1
...
### 6. Add JSON Schema validation helpers
**Blocked by:** 1
...
### 29. Set up frontend shell, navigation, WebSocket client
**Blocked by:** 1
