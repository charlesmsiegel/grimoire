...
US_FEDERAL = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(
            id="memorial-day",
            name="Memorial Day",
            rule=HolidayRule.LAST_WEEKDAY,
            weekday_month=5,
            weekday=0,
        ),  # last Monday of May
        Holiday(id="juneteenth", name="Juneteenth", rule=HolidayRule.FIXED, month=6, day=19),
        Holiday(
            id="independence-day", name="Independence Day", rule=HolidayRule.FIXED, month=7, day=4
        ),
        Holiday(
            id="labor-day",
            name="Labor Day",
        ...
        Holiday(id="veterans-day", name="Veterans Day", rule=HolidayRule.FIXED, month=11, day=11),
        Holiday(
            id="thanksgiving",
            name="Thanksgiving",
            rule=HolidayRule.NTH_WEEKDAY,
...
UK_BANK = HolidaySet(
    ...
    holidays=[
        Holiday(id="new-years-day", name="New Year's Day", rule=HolidayRule.FIXED, month=1, day=1),
        Holiday(
            id="good-friday", name="Good Friday", rule=HolidayRule.EASTER_WESTERN, offset_days=-2
        ),
        Holiday(
            id="easter-monday", name="Easter Monday", rule=HolidayRule.EASTER_WESTERN, offset_days=1
        ),
        Holiday(
            id="early-may",
...
CANADIAN_FEDERAL = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(
            ...
            weekday=0,
            nth=4,
        ),  # Mon on or before May 24 — approximate
        ...
        Holiday(
            id="remembrance-day", name="Remembrance Day", rule=HolidayRule.FIXED, month=11, day=11
        ),
        Holiday(id="christmas", name="Christmas Day", rule=HolidayRule.FIXED, month=12, day=25),
        Holiday(id="boxing-day", name="Boxing Day", rule=HolidayRule.FIXED, month=12, day=26),
    ],
...
EU_COMMON = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(id="ascension", name="Ascension", rule=HolidayRule.EASTER_WESTERN, offset_days=39),
        Holiday(
            id="whit-monday", name="Whit Monday", rule=HolidayRule.EASTER_WESTERN, offset_days=50
        ),
        Holiday(id="all-saints", name="All Saints' Day", rule=HolidayRule.FIXED, month=11, day=1),
        Holiday(id="christmas", name="Christmas Day", rule=HolidayRule.FIXED, month=12, day=25),
        Holiday(
            id="st-stephens", name="St. Stephen's Day", rule=HolidayRule.FIXED, month=12, day=26
        ),
    ],
)
...
CHRISTIAN_WESTERN = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(
            id="ash-wednesday",
            name="Ash Wednesday",
            rule=HolidayRule.EASTER_WESTERN,
            offset_days=-46,
        ),
        Holiday(
            id="palm-sunday", name="Palm Sunday", rule=HolidayRule.EASTER_WESTERN, offset_days=-7
        ),
        Holiday(
            id="good-friday", name="Good Friday", rule=HolidayRule.EASTER_WESTERN, offset_days=-2
        ),
        Holiday(id="easter", name="Easter Sunday", rule=HolidayRule.EASTER_WESTERN, offset_days=0),
        Holiday(id="ascension", name="Ascension", rule=HolidayRule.EASTER_WESTERN, offset_days=39),
        Holiday(id="pentecost", name="Pentecost", rule=HolidayRule.EASTER_WESTERN, offset_days=49),
        Holiday(id="all-saints", name="All Saints' Day", rule=HolidayRule.FIXED, month=11, day=1),
        Holiday(
            id="advent-1",
        ...
        Holiday(id="christmas-eve", name="Christmas Eve", rule=HolidayRule.FIXED, month=12, day=24),
        Holiday(id="christmas", name="Christmas Day", rule=HolidayRule.FIXED, month=12, day=25),
    ],
)
...
CHRISTIAN_ORTHODOX = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(
            ...
            name="Good Friday",
            rule=HolidayRule.EASTER_ORTHODOX,
            offset_days=-2,
        ),
        Holiday(id="pascha", name="Pascha", rule=HolidayRule.EASTER_ORTHODOX, offset_days=0),
        Holiday(
            id="pentecost-orthodox",
            name="Pentecost",
            rule=HolidayRule.EASTER_ORTHODOX,
            offset_days=49,
        ),
...
JAPANESE_PUBLIC = HolidaySet(
    ...
    holidays=[
        Holiday(
            id="new-years-day", name="元日 (New Year's Day)", rule=HolidayRule.FIXED, month=1, day=1
        ),
        Holiday(
            id="coming-of-age",
            name="成人の日 (Coming of Age Day)",
            rule=HolidayRule.NTH_WEEKDAY,
            weekday_month=1,
            weekday=0,
            nth=2,
        ...
        Holiday(
            id="vernal-equinox",
            name="春分の日 (Vernal Equinox Day)",
            rule=HolidayRule.FIXED,
            month=3,
            day=20,
        ),  # approximation
        Holiday(
            id="showa-day", name="昭和の日 (Showa Day)", rule=HolidayRule.FIXED, month=4, day=29
        ),
        Holiday(
            id="constitution-memorial",
        ...
        Holiday(
            id="mountain-day", name="山の日 (Mountain Day)", rule=HolidayRule.FIXED, month=8, day=11
        ),
        Holiday(
            id="respect-for-aged",
            name="敬老の日 (Respect for the Aged Day)",
            rule=HolidayRule.NTH_WEEKDAY,
            weekday_month=9,
            weekday=0,
            nth=3,
        ...
        Holiday(
            id="autumnal-equinox",
            name="秋分の日 (Autumnal Equinox Day)",
            rule=HolidayRule.FIXED,
            month=9,
            day=23,
        ),
        ...
        Holiday(
            id="culture-day", name="文化の日 (Culture Day)", rule=HolidayRule.FIXED, month=11, day=3
        ),
        Holiday(
            id="labour-thanksgiving",
            name="勤労感謝の日 (Labour Thanksgiving)",
            rule=HolidayRule.FIXED,
            month=11,
            day=23,
        ),
...
CHINESE_TRADITIONAL = HolidaySet(
    ...
    holidays=[
        Holiday(
            id="lunar-new-year",
            name="春节 (Spring Festival / Lunar New Year)",
            rule=HolidayRule.LUNAR_NEW_YEAR,
            offset_days=0,
            duration_days=7,
        ),
        Holiday(
            id="lantern-festival",
            name="元宵节 (Lantern Festival)",
            rule=HolidayRule.LUNAR_NEW_YEAR,
            offset_days=14,
        ),
        Holiday(
...
HINDU_MAJOR = HolidaySet(
    ...
    holidays=[
        Holiday(
            id="makar-sankranti", name="Makar Sankranti", rule=HolidayRule.FIXED, month=1, day=14
        ),
        Holiday(
            id="republic-day-in",
        ...
        Holiday(id="holi", name="Holi (approximate)", rule=HolidayRule.FIXED, month=3, day=8),
        Holiday(
            id="ram-navami",
            name="Ram Navami (approximate)",
            rule=HolidayRule.FIXED,
            month=4,
            day=10,
        ),
        ...
        Holiday(
            id="janmashtami",
            name="Krishna Janmashtami (approximate)",
            rule=HolidayRule.FIXED,
            month=8,
            day=27,
        ),
        Holiday(
            id="ganesh-chaturthi",
            name="Ganesh Chaturthi (approximate)",
            rule=HolidayRule.FIXED,
            month=9,
            day=7,
        ),
        ...
        Holiday(
            id="dussehra", name="Dussehra (approximate)", rule=HolidayRule.FIXED, month=10, day=12
        ),
        Holiday(
            id="diwali",
...
BUDDHIST_MAJOR = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(
            id="songkran",
            name="Songkran / Buddhist New Year",
            rule=HolidayRule.FIXED,
            month=4,
            day=13,
            duration_days=3,
        ...
        Holiday(
            id="vesak",
            name="Vesak / Buddha Day (approximate)",
            rule=HolidayRule.FIXED,
            month=5,
            day=23,
        ),
        Holiday(
            id="asalha-puja",
            name="Asalha Puja (approximate)",
            rule=HolidayRule.FIXED,
            month=7,
            day=21,
        ),
        Holiday(id="bodhi-day", name="Bodhi Day", rule=HolidayRule.FIXED, month=12, day=8),
    ],
)
...
WHEEL_OF_THE_YEAR = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(
            id="ostara", name="Ostara (Spring Equinox)", rule=HolidayRule.FIXED, month=3, day=20
        ),
        Holiday(id="beltane", name="Beltane", rule=HolidayRule.FIXED, month=5, day=1),
        Holiday(
            id="litha", name="Litha (Summer Solstice)", rule=HolidayRule.FIXED, month=6, day=21
        ),
        Holiday(id="lammas", name="Lammas / Lughnasadh", rule=HolidayRule.FIXED, month=8, day=1),
        Holiday(id="mabon", name="Mabon (Autumn Equinox)", rule=HolidayRule.FIXED, month=9, day=22),
        Holiday(id="samhain", name="Samhain", rule=HolidayRule.FIXED, month=10, day=31),
        Holiday(id="yule", name="Yule (Winter Solstice)", rule=HolidayRule.FIXED, month=12, day=21),
    ],
)
...
INTERNATIONAL_OBSERVANCES = HolidaySet(
    ...
    description="Secular international days widely recognized by the UN and global civil society.",
    ...
    holidays=[
        ...
        Holiday(
            id="world-press", name="World Press Freedom Day", rule=HolidayRule.FIXED, month=5, day=3
        ),
        Holiday(
        ...
        Holiday(
            id="pride-day",
            name="LGBTQ+ Pride Day (Stonewall)",
            rule=HolidayRule.FIXED,
            month=6,
            day=28,
        ),
        Holiday(id="un-day", name="United Nations Day", rule=HolidayRule.FIXED, month=10, day=24),
        Holiday(
            id="human-rights", name="Human Rights Day", rule=HolidayRule.FIXED, month=12, day=10
        ),
    ],
)
...
JEWISH_HOLIDAYS = HolidaySet(
    ...
    holidays=[
        ...
        Holiday(id="yom-kippur", name="Yom Kippur", rule=HolidayRule.FIXED, month=1, day=10),
        Holiday(
            id="sukkot", name="Sukkot", rule=HolidayRule.FIXED, month=1, day=15, duration_days=7
        ),
        Holiday(
            id="shemini-atzeret",
        ...
        Holiday(
            id="chanukah", name="Chanukah", rule=HolidayRule.FIXED, month=3, day=25, duration_days=8
        ),
        Holiday(id="tu-bishvat", name="Tu BiShvat", rule=HolidayRule.FIXED, month=5, day=15),
        Holiday(
            id="purim",
            name="Purim",
            rule=HolidayRule.FIXED,
        ...
        Holiday(
            id="shavuot", name="Shavuot", rule=HolidayRule.FIXED, month=9, day=6, duration_days=2
        ),
        Holiday(id="tisha-bav", name="Tisha B'Av", rule=HolidayRule.FIXED, month=11, day=9),
    ],
)
...
ISLAMIC_HOLIDAYS = HolidaySet(
    ...
    holidays=[
        Holiday(
            id="hijri-new-year", name="Islamic New Year", rule=HolidayRule.FIXED, month=1, day=1
        ),
        Holiday(id="ashura", name="Day of Ashura", rule=HolidayRule.FIXED, month=1, day=10),
        Holiday(id="mawlid", name="Mawlid an-Nabi", rule=HolidayRule.FIXED, month=3, day=12),
        Holiday(id="isra-miraj", name="Isra and Mi'raj", rule=HolidayRule.FIXED, month=7, day=27),
        Holiday(
            id="ramadan-start",
        ...
        Holiday(
            id="laylat-al-qadr", name="Laylat al-Qadr", rule=HolidayRule.FIXED, month=9, day=27
        ),
        Holiday(
            id="eid-al-fitr",
            name="Eid al-Fitr",
        ...
        Holiday(id="day-of-arafah", name="Day of Arafah", rule=HolidayRule.FIXED, month=12, day=9),
        Holiday(
            id="eid-al-adha",
            name="Eid al-Adha",
            rule=HolidayRule.FIXED,
